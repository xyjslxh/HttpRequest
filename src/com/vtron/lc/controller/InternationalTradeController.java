...
public class InternationalTradeController {
	...
	@ResponseBody
	public JSONObject declare(String url, String clientId, String key, String messageType, String messageText)
			throws DocumentException {
		// SAXReader reader = new SAXReader();
		// System.out.println(messageText);
		// messageText = URLEncoder.encode(messageText, "UTF-8");
		// 发送 POST 请求
		String sr = HttpRequest.sendPost(url, "clientId=" + clientId + "&key=" + key + "&messageType=" + messageType
				+ "&messageText=" + messageText);
		System.out.println(sr);
		JSONObject result = JSONObject.fromObject(sr);
		// System.out.println(result.getString("description"));
//		Document document = DocumentHelper.parseText(result.getString("description"));
